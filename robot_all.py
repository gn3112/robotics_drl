...
# from pyrep.robots.arms.robot import robot
...
class robotAll(robotArm, robotBase):
    ...
    def get_observation(self):
        _, obsArm = robotArm.get_observation(self)
        _, obsBase = robotBase.get_observation(self)
    ...
    def step(self,action):
        ...
        for _ in range(self.rpa):
            dem_action_base = robotBase._set_actuation(self,action[:3])
            dem_action_arm = robotArm._set_actuation(self,action[3:])
